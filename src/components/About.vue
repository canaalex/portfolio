...
import city from "../assets/kochicity.png"
...
<template>
  <div
    class="pb-12 px-24 pt-40 bg-gradient-to-r from-red-200 to-amber-100 h-full w-full flex flex-col items-center"
  >
    <div
      className="relative font-extrabold text-10xl aladin-regular text-dark-green mb-8"
    >
      <div>I'm Riya.</div>
    </div>
    <div class="flex flex-col md:flex-row justify-between py-12 gap-24">
      <div
        class="w-full md:w-2/5 flex justify-center md:justify-end mt-8 md:mt-0"
      >
        <div
          class="relative w-96 h-96 overflow-hidden rounded-t-full bg-dark-green"
        >
          <img
            :src="profile"
            alt="Your Image"
      ...
      <div class="w-full md:w-3/5">
        <p
          class="tracking-tight text-left text-8xl aladin-regular text-dark-green"
        >
    ...
    <div class="flex flex-row gap-4 mt-20">
       <div>
        <img :src="city" className="w-844px h-542px rounded-xl"/>
       </div>
       <img :src="water" className="w-477px h-542px rounded-xl"/>
    </div>
    ...
    <div class="mt-36">
       <div>
        <img :src="bear" className="w-64 h-auto rounded-xl"/>
       </div>
